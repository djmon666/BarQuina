...
def generate_payment_receipt(order: Order, payment: Payment, cash_given: float = 0.0) -> str:
    ...
    # Si és efectiu, mostrar diners donats i canvi
    if payment.method.value == 'efectiu' and cash_given > 0:
        lines.append(left_right_text("Efectiu donat:", format_price(cash_given), width))
